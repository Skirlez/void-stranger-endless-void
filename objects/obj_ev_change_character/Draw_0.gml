...
draw_sprite(asset_get_index("spr_ev_swapper"),0, x - 32, y + 20)
...
if global.blade_style == 2 
	draw_sprite_part_ext(asset_get_index("spr_ev_items_lev"), 0, 48, 0, 16, 16, x + 16, y + 20, 1, 1, image_blend, image_alpha)
else
